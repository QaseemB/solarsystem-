...
const solarSystem = [
    ...
    const xyz =solarSystem[1].moons.push("Endor")
    ...
    // solarSystem.forEach(r =>{
    //     if (r.ringSystem = true);
    //         console.log(r)
    // })
    ...
    let jupiterSatellites = parseFloat(system.jupiter.satellites)
    let s = +system.saturn.satellites
    let u = +system.uranus.satellites
    let n = +system.neptune.satellites
    // console.log( u + n + s + jupiterSatellites )
